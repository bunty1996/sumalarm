...
public class Renderer {
    ...
    public void DrawCubicPath(Canvas canvas, List<ChartData> dataList, Paint paint, float height, boolean area_spline) {
    ...
    public void DrawCircle(Canvas canvas, List<ChartData> dataset, Paint paint, float radius){
