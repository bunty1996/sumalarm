...
public class ExpandableRecyclerView extends RecyclerView {
    ...
    public static abstract class Adapter<CVH extends ViewHolder, GVH extends ViewHolder, C, G> extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int i) {
            ...
            while (group <= getGroupItemCount()) {
                ...
                if (i == 0) {
                    onBindGroupViewHolder((GVH) holder, group,i);
                    return;
                }
            }
            throw new IndexOutOfBoundsException();
      ...
      /*  public void setOnParentItemClickedListener(OnParentItemClickedListener onItemClickedListener) {
            this.onParentItemClickedListener = onItemClickedListener;
        }*/
        ...
        public void onBindGroupViewHolder(final GVH holder, final int group , final int position) {
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isExpanded(group)) {
                        Log.e("clicked","clicked collapse");
                        collapse(group);
                        value="0";
                        if (holder instanceof GroupViewHolder)
                        ...
                        Log.e("clicked","clicked expand");
                    }

                    if (Adapter.this.onChildItemClickedListener != null) {
                        Adapter.this.onChildItemClickedListener.onParentItemClicked(group, position,value);
                    }
    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder {
        ...
        public SimpleGroupViewHolder(Context context) {
            super(View.inflate(context, R.layout.expandable_list_group, null));
    ...
    public interface OnChildItemClickedListener {
        ...
        void onParentItemClicked(int group, int position,String value);
    }
