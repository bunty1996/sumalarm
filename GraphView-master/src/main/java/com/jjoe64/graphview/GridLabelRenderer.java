...
public class GridLabelRenderer {
    ...
    public final class Styles {
         ...
         * and #horizontalAxisTitl0eTextSize
         */
    ...
    public void setmNumVerticalLabels(int mNumVerticalLabels) {
    ...
    public int getmNumHorizontalLabels() {
        return mNumHorizontalLabels;
    }

    public void setmNumHorizontalLabels(int mNumHorizontalLabels) {
    ...
    public void setGraphType(GraphView.GraphType graphType) {
        this.graphType = graphType;
    }

    GraphView.GraphType graphType = GraphView.GraphType.Today;
    ...
    public void resetStyles() {
        ...
        try {
            ...
            color1 = array.getColor(0, Color.parseColor("#006EBE"));
            color2 = array.getColor(1, Color.parseColor("#006EBE"));
            ...
            color1 = Color.parseColor("#006EBE");
            color2 = Color.parseColor("#006EBE");
            size = 20;
            size2 = 20;
    ...
    protected boolean adjustVerticalSecondScale() {
        ...
        if (sensorId.equalsIgnoreCase("5") || sensorId.equalsIgnoreCase("6"))
            mNumVerticalLabels = 2;
    ...
    protected void drawHorizontalAxisTitle(Canvas canvas) {
        if (mHorizontalAxisTitle != null && mHorizontalAxisTitle.length() > 0) {
            ...
            //canvas.drawText(mHorizontalAxisTitle, 5,5, mPaintAxisTitle);
        }
    }
    ...
    //todo for return date
    protected String label(String data) {
...
//        num = Long.parseLong(data.replace(",", ""));
        //Date date = new Date((long) (Double.valueOf(stringBuilder.toString()) * 1000));
        date = new Date((long) (Double.valueOf(stringBuilder.toString()) * 1000));

        //date = new Date(num * 1000);
        //date = new Date(num);
        //date= new Date(num);
        //Date date = new Date((long) ((new Double(stringBuilder.toString())).longValue()));
        String newString = null;

        Log.e("graph_type",graphType+""+(graphType == GraphView.GraphType.Week)+"//"+(graphType == GraphView.GraphType.Today));
        if (graphType == GraphView.GraphType.Week){
        ...
        //newString = new SimpleDateFormat("hh:mm a").format(date); // 9:00
          ...
          //  newString = new SimpleDateFormat("hh:mm a").format(date); // 9:00
         newString = new SimpleDateFormat("HH:mm").format(date); // 9:00

        }


         /*if (graphType == GraphView.GraphType.Today)
            newString = new SimpleDateFormat("hh:mm a").format(date); // 9:00
        else
            newString = new SimpleDateFormat("dd MMM yy").format(date); // 9:00*/
        Log.e("datee", newString + "//");
        return newString;
    }
    ...
    protected void drawHorizontalSteps(Canvas canvas) {
        ...
        mPaintLabel.setColor(Color.parseColor("#006EBE"));
        int i = 0;
            ...
            if (isHorizontalLabelsVisible()) {
                ...
                for (int li = 0; li < lines.length; li++) {
                    ...
                    if (mStyles.horizontalLabelsAngle > 0 && mStyles.horizontalLabelsAngle < 90f) {
                        ...
                        if (li == 0 || li == lines.length - 1 || (li == pos) || (li == pos * 2)) {

                            canvas.save();
                            canvas.rotate(mStyles.horizontalLabelsAngle, x + labelWidthAdj, y);
                            Log.v("Tag", "Lines " + lines[li] + "//" + li);

                            canvas.drawText(label(lines[li]), x + labelWidthAdj, y, mPaintLabel);
                        ...
                        if (li == 0 || li == (lines.length - 1) || (li == pos) || (li == pos * 2)) {
                            ...
                            canvas.drawText(label(lines[li]), x, y, mPaintLabel);
                            canvas.restore();
                            Log.v("Tag", "Lines3 " + lines[li] + "//" + mStyles.horizontalLabelsAngle + "//" + li);
    ...
    protected void drawVerticalSteps(Canvas canvas) {
        ...
        int currentLine = 1;
        Log.e("numberLine", numberOfLine + "//");
        for (Map.Entry<Integer, Double> e : mStepsVertical.entrySet()) {

            float posY = mGraphView.getGraphContentTop() + mGraphView.getGraphContentHeight() - e.getKey();
            Log.e("Gridrenderval1", e.getValue() + "//" + numberOfLine);
            //draw line
            if (mStyles.highlightZeroLines) {
                if (e.getValue() == 0d) {
                    mPaintLine.setStrokeWidth(5);
            ...
            if ((mStyles.verticalLabelsVAlign == VerticalLabelsVAlign.ABOVE && currentLine == 1) || (mStyles.verticalLabelsVAlign == VerticalLabelsVAlign.BELOW && currentLine == numberOfLine)) {
                isDrawLabel = false;
            }
            ...
            if (isVerticalLabelsVisible() && isDrawLabel) {
                ...
                for (int li = 0; li < lines.length; li++) {
                    //for the last line y = height
                    float y2 = y - (lines.length - li - 1) * getTextSize() * 1.1f;
                    //todo for set on off on graph

                    if (sensorId.equalsIgnoreCase("11")) {

                        //todo for wifi graph

                        canvas.drawText(lines[li] + " dbm", labelsOffset + 5, y2, mPaintLabel);
                        Log.e( "drawVerticalSteps ",lines[li]+""+labelsOffset+5+""+y2 );

//                        if (lines[li].equalsIgnoreCase("1")) {
//                            canvas.drawText("Low ", labelsOffset + 5, y2, mPaintLabel);
//                        } else if (lines[li].equalsIgnoreCase("2")) {
//                            canvas.drawText(" Medium ", labelsOffset + 5, y2, mPaintLabel);
//                        } else if (lines[li].equalsIgnoreCase("3")) {
//                            canvas.drawText(" Good ", labelsOffset + 5, y2, mPaintLabel);
//                        } else if (lines[li].equalsIgnoreCase("4")) {
//                            canvas.drawText(" Excellent ", labelsOffset + 5, y2, mPaintLabel);
//                        }

                    }
//                    else if (sensorId.equalsIgnoreCase("4")) {
//                        Log.e("batry", lines[li] + "//");
//                        //todo for wifi graph
//                        if (lines[li].equalsIgnoreCase("0")) {
//                            Log.e("lowbatry", lines[li] + "//");
//                            canvas.drawText(" Low ", labelsOffset + 5, y2, mPaintLabel);
//                        } else if (lines[li].equalsIgnoreCase("2")) {
//                            canvas.drawText(" Discharging ", labelsOffset + 5, y2, mPaintLabel);
//                        } else if (lines[li].equalsIgnoreCase("4")) {
//                            canvas.drawText(" Charging ", labelsOffset + 5, y2, mPaintLabel);
//                        }
//
//                    }
//                    else if (sensorId.equalsIgnoreCase("4")) {
//
//                        if(lines[li].equalsIgnoreCase("4"))
//                            canvas.drawText("0%", labelsOffset + 5, y2, mPaintLabel);
//                       else if(lines[li].equalsIgnoreCase("4.1"))
//                            canvas.drawText("10%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.2"))
//                            canvas.drawText("20%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.3"))
//                            canvas.drawText("30%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.4"))
//                            canvas.drawText("40%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.5"))
//                            canvas.drawText("50%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.6"))
//                            canvas.drawText("60%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.7"))
//                        canvas.drawText("70%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.8"))
//                            canvas.drawText("80%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("4.9"))
//                            canvas.drawText("90%", labelsOffset + 5, y2, mPaintLabel);
//                        else if(lines[li].equalsIgnoreCase("5"))
//                            canvas.drawText("100%", labelsOffset + 5, y2, mPaintLabel);
//                    }
                    else if (sensorId.equalsIgnoreCase("4")) {
                        canvas.drawText(lines[li] + "%", labelsOffset + 5, y2, mPaintLabel);
                    }
                    else if (sensorId.equalsIgnoreCase("5") || sensorId.equalsIgnoreCase("6")) {
                        if (lines[li].equalsIgnoreCase("0"))
                            canvas.drawText(" OFF ", labelsOffset + 5, y2, mPaintLabel);
                        else canvas.drawText(" ON ", labelsOffset + 5, y2, mPaintLabel);

                    } else if (sensorId.equalsIgnoreCase("2")) {
                        canvas.drawText(lines[li] + "F", labelsOffset + 5, y2, mPaintLabel);
